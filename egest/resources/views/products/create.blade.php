<x-app-layout>
    <div class="mb-4">
        <h2 class="text-base font-bold text-white tracking-tight">Ajouter un nouveau produit</h2>
        <p class="text-[11px] text-slate-500">Boutique : <span class="text-blue-400 font-medium">{{ request()->getHost() }}</span></p>
    </div>

    <div class="max-w-xl" x-data="productForm({ categoriesList: {{ $categories->toJson() }}, defaultCategory: '' })">
        ...
        <div class="bg-[#090d16] rounded-xl border border-slate-800/80 shadow-2xl p-4">
            <form action="{{ route('products.store') }}" method="POST" class="space-y-3.5">
                ...
                <div>
                    ...
                    <input type="text" name="name" required placeholder="Ex: Robe Zara d'été"
                ...
                <div class="grid grid-cols-2 gap-3.5">
                    ...
                    <div>
                        ...
                        <input type="text" name="target" placeholder="Ex: Femme, Homme"
                ...
                <div class="grid grid-cols-2 gap-3.5">
                    <div>
                        <label class="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Stock Initial</label>
                        <input type="number" name="stock_quantity" required placeholder="20"
                            class="w-full px-3 py-1.5 bg-slate-900/50 border border-slate-800/80 text-xs rounded-lg text-slate-200 focus:outline-hidden focus:border-blue-500/40">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input type="text" name="description" placeholder="Détails du produit..."
                        class="w-full px-3 py-1.5 bg-slate-900/50 border border-slate-800/80 text-xs rounded-lg text-slate-200 focus:outline-hidden focus:border-blue-500/40">
                </div>
